  ...
  return (
    <div>
      <section className="relative flex flex-col lg:flex-row items-center justify-center h-auto lg:h-screen bg-white">
        <section className="relative flex flex-col lg:flex-row items-center justify-center h-auto lg:h-screen bg-[#CCBB8E]">
          {/* Imagen izquierda */}
      ...
      <section className="bg-white min-h-screen grid grid-cols-2 gap-4 lg:grid-cols-5 lg:grid-rows-2 lg:gap-4">
        ...
        {/* Cards de los miembros */}
        <div className="flex justify-center items-start row-start-1 col-start-1 lg:row-start-1 lg:col-start-1 hover:scale-105 transition-transform duration-300 cursor-pointer overflow-hidden"
