...
import Testimonios from "./Testimonios"; // Asegúrate de importar el componente Testimonios
...
const Home = () => {
  return (
    <div>
      ...
      {/* Benefits Section */}
<section className="flex flex-col md:flex-row items-center md:items-start justify-between px-8 py-16 bg-[#CCBB8E] mb-16 rounded-xl shadow-xl">
